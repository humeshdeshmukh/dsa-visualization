          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                An interactive platform for learning Data Structures and Algorithms through visual representations and step-by-step animations.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="/data-structures" className="text-gray-400 hover:text-white transition-colors">Data Structures</a>
                </li>
                <li>
                  <a href="/algorithms" className="text-gray-400 hover:text-white transition-colors">Algorithms</a>
                </li>
                <li>
                  <a href="/visualizer" className="text-gray-400 hover:text-white transition-colors">Visualizer</a>
                </li>
                <li>
                  <a href="/practice" className="text-gray-400 hover:text-white transition-colors">Practice</a>
                </li>
              </ul>
            </div>
