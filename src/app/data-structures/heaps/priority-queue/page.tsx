...
// Using the same code as before but in the correct directory
...
export default function PriorityQueuePage() {
  ...
  return (
    <VisualizerLayout
      title="Priority Queue (Min Heap) Visualization"
      description="Visualize a priority queue implemented as a binary min heap, where lower priority numbers have higher precedence."
    >
      <VisualizationProvider>
        <div className="space-y-6">
          ...
          <div className="glass-dark border border-white/10 rounded-lg p-6 space-y-4">
            <h3 className="text-lg font-semibold text-white">Priority Queue (Min Heap) Properties</h3>
            <div className="space-y-2 text-gray-300">
              <p><strong>Time Complexity:</strong></p>
              <ul className="list-disc list-inside mt-2 ml-4">
                <li>Enqueue (Insert): O(log n)</li>
                <li>Dequeue (Extract Min): O(log n)</li>
                <li>Peek (Get Min): O(1)</li>
              </ul>
              <p><strong>Space Complexity:</strong> O(n)</p>
              <p><strong>Heap Properties:</strong></p>
              <ul className="list-disc list-inside mt-2 ml-4">
                <li>Complete binary tree</li>
                <li>Parent's priority ≤ children's priorities</li>
                <li>Root has minimum priority</li>
